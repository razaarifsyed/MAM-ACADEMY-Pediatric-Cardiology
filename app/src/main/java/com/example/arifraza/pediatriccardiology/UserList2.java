...
import java.util.List;
public class UserList2 extends ArrayAdapter<user>{


    private Activity context;
    private List<user> userList;

    public UserList2(Activity context, List<user> userList) {
        super(context, R.layout.list_layout5, userList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem3 = inflater.inflate(R.layout.list_layout5, null, true);
        ...
        textView7.setText("\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+"\t"+user.getdname());
